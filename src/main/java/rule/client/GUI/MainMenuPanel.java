...
public class MainMenuPanel extends JPanel {
    ...
    MainMenuPanel() {
        ...
        ImageIcon mainMenuLabelPicture = new ImageIcon(Assets.getImageIcon("background.jpg").getImage().getScaledInstance(1920, -1, Image.SCALE_SMOOTH));
